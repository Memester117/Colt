...
////////////////////sunlight color////////////////////
////////////////////sunlight color////////////////////
const ivec4 ToD[25] = ivec4[25](ivec4(0,100,134,48), //hour,r,g,b
							    ivec4(1,100,134,48),
								ivec4(2,100,134,48),
								ivec4(3,100,134,48),
								ivec4(4,100,134,48),
...
void main() {
	moonlight = ivec3(3,3,3)/255.0/10.0;
...
ambient_color = mix(sky_color, nsunlight,1-exp(-0.16*tL*(1-rainStrength*1.0)))*tL*sunVisibility*(1-rainStrength*1.0) + tLMoon*moonVisibility*moonlight;
eyeAdapt = (2.0-min(length(ambient_color),eyeBrightnessSmooth.y/200.0*1.7));
